        ...
        <div className="sm:px-8 px-4 grow">
          ...
          <div className='text-white text-base flex gap-2'>
            ...
            <table className="mr-2">
              <tbody>
                <tr>
                  <td className="font-bold text-red-600 text-base pb-6">
                    Objectve
                  </td>
                  <td className="px-2 pb-6">-</td>
                  <td className="font-semibold text-white  sm:text-base pl-2 text-sm">
                    <p className="break-words">
                      This website contains Information about me and my software
                      development skills. It is also showcasing the projects
                      that i have created.
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td className="font-bold text-white  text-base pt-6">
                    Source code
                  </td>
                  <td className="px-2">-</td>
                  <td className="font-semibold text-red-500  sm:text-base text-sm pl-3 break-all">
                    <Link href={"https://github.com/Mostafizur-Pro"}>
                      https://github.com/Mostafizur-Pro
                    </Link>
                  </td>
                </tr>
              </tbody>
