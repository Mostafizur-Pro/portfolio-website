...
import Laravel from "@/components/main/Laravel";
        ...
        <div className="sm:px-8 px-4 grow">
          ...
          <div className="text-white ml-6 mt-8 text-base ">
            <div className="flex gap-2">
              ...
              <div className="font-semibold">Lifecare</div>
            </div>
            <div className="flex gap-2">
            ...
            <div className="flex gap-2">
              ...
              <div className="text-red-600 font-bold">Uncompleted</div>
            </div>
            <div className="my-4">
              <div className="text-red-600 font-bold">Description</div>
              <div className="font-semibold sm:text-base text-sm">
                The Hospital Management Website is a comprehensive web
                application designed to streamline and optimize the operations
                of a hospital or healthcare facility. With a user-friendly
                interface and robust features, this website serves as a
                centralized platform for managing various aspects of hospital
                administration, patient care, and resource allocation.
              </div>
            </div>
            <div className="text-red-600 font-bold">Images</div>
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/laravel/project04/image01.png"
                width={700}
                height={700}
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/laravel/project04/image02.png"
                width={700}
                height={700}
                className="border-4 border-sky-300 rounded-lg"
                alt="spin"
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/laravel/project04/image03.png"
                width={700}
                height={700}
                className="border-4 border-sky-300 rounded-lg"
                alt="spin"
            ...
            {/* <div className="sm:ml-6 mt-4">
              <Image
                src="/images/laravel/project03/image04.png"
                width={700}
                height={700}
                className="border-4 border-sky-300 rounded-lg"
                alt="spin"
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/laravel/project03/image05.png"
                width={700}
                height={700}
                className="border-4 border-sky-300 rounded-lg"
                alt="spin"
                  ...
                  <td className="font-semibold text-red-600  sm:text-base text-sm pl-6  break-all">
                    <ul className="list-disc">
                      <li>
                        ...
                        <Link
                          target="_blank"
                          href={"https://lifecare-bd.vercel.app/"}
                        >
                          Live Link
                        </Link>
                      </li>
                      <li>
                        ...
                        <Link
                          href={"https://github.com/Mostafizur-Pro/lifecare"}
                        >
                          Client Side
                        </Link>
                      </li>
