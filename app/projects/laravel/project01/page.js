        ...
        <div className="sm:px-8 px-4 grow">
          ...
          <div className="text-white ml-6 mt-8 text-base ">
            ...
            <div className="flex gap-2">
              ...
              <div>V1 Completed, V2 Running</div>
            </div>
            <div className="my-4">
              ...
              <div className="font-semibold sm:text-base text-sm">
                ...
                stakeholders. Features include:
                <ul className="list-disc ml-6 mt-2">
                  <li>Student Enrollment and Registration</li>
                  <li>Attendance Management</li>
                  <li>Faculty and Staff Directory</li>
                  <li>Classroom Scheduling and Timetabling</li>
                  <li>Gradebook and Academic Progress Tracking</li>
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/laravel/project01/image01.png"
                width={700}
                height={700}
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/laravel/project01/image02.png"
                width={700}
                height={700}
                className="border-4 border-sky-300 rounded-lg"
                alt="spin"
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/laravel/project01/image03.png"
                width={700}
                height={700}
                className="border-4 border-sky-300 rounded-lg"
                alt="spin"
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/laravel/project01/image04.png"
                width={700}
                height={700}
                className="border-4 border-sky-300 rounded-lg"
                alt="spin"
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/laravel/project01/image05.png"
                width={700}
                height={700}
                className="border-4 border-sky-300 rounded-lg"
                alt="spin"
                ...
                <tr>
                  ...
                  <td className="font-semibold text-red-600  sm:text-base text-sm pl-6  break-all">
                    <ul className="list-disc">
                      <li>
                        {" "}
                        <Link target="_blank" href={"https://cms.nedubd.com/"}>
                          Live Link
                        </Link>
                      </li>
                      <li>
