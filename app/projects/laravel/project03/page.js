        ...
        <div className="sm:px-8 px-4 grow">
          ...
          <div className="text-white ml-6 mt-8 text-base ">
            <div className="flex gap-2">
              ...
              <div className="font-semibold">SKSA Bangladesh</div>
            </div>
            <div className="flex gap-2">
            ...
            <div className="my-4">
              ...
              <div className="font-semibold sm:text-base text-sm">
                Shotokan Karate-Do Sports Association Bangladesh (SKSA
                Bangladesh) SKSA Bangladesh provides the best Shotokan Karate-Do
                practice to beginners and experts. SKSA International is a
                global association dedicated to teaching and promoting Shotokan
                karate and other martial arts in General.
              </div>
            </div>
            <div className="text-red-600 font-bold">Images</div>
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/laravel/project03/image01.png"
                width={700}
                height={700}
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/laravel/project03/image02.png"
                width={700}
                height={700}
                className="border-4 border-sky-300 rounded-lg"
                alt="spin"
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/laravel/project03/image03.png"
                width={700}
                height={700}
                className="border-4 border-sky-300 rounded-lg"
                alt="spin"
                ...
                <tr>
                  ...
                  <td className="font-semibold text-red-600  sm:text-base text-sm pl-6  break-all">
                    <ul className="list-disc">
                      <li>
                        {" "}
                        <Link target="_blank" href={"https://sksabd.com/"}>
                          Live Link
                        </Link>
                      </li>
                      <li>
