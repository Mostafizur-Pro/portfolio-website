          ...
          <div className="text-white ml-6 mt-8 text-base ">
            ...
            <div className="my-4">
              ...
              <div className="font-semibold sm:text-base text-sm">
                An app to provide mechanic service to user on site. It will help
                reach nearby mechanics in unexpected situation with user
                vehicle. It have live location to track both user and mechanics.
              </div>
            </div>
            ...
            <table>
              <tbody>
                ...
                <tr>
                  <td className="font-bold text-white  text-base pb-6 pt-6">
                    Tools used
                  </td>
