        ...
        <div className="sm:px-8 px-4 grow">
          ...
          <div className="text-white ml-6 mt-8 text-base ">
            <div className="flex gap-2">
              ...
              <div className="font-semibold">Demo Profile </div>
            </div>
            <div className="flex gap-2">
            ...
            <div className="my-4">
              ...
              <div className="font-semibold sm:text-base text-sm">
                Our Madrasah Management Website offers a comprehensive solution
                tailored to meet the diverse needs of Madrasah administrators,
                teachers, students, and parents. With user-friendly interfaces
                and robust functionality, our platform revolutionizes the
                management of Islamic educational institutions, empowering them
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/react/project05/image01.png"
                width={700}
                height={700}
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/react/project05/image02.png"
                width={700}
                height={700}
                className="border-4 border-sky-300 rounded-lg"
                alt="spin"
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/react/project05/image03.png"
                width={700}
                height={700}
                className="border-4 border-sky-300 rounded-lg"
                alt="spin"
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/react/project05/image04.png"
                width={700}
                height={700}
                className="border-4 border-sky-300 rounded-lg"
                alt="spin"
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/react/project05/image05.png"
                width={700}
                height={700}
                className="border-4 border-sky-300 rounded-lg"
                alt="spin"
                ...
                <tr>
                  ...
                  <td className="font-semibold text-red-600  sm:text-base text-sm pl-6  break-all">
                    <ul className="list-disc">
                      <li>
                        {" "}
                        <Link target="_blank" href={"https://m.baitsbd.com/"}>
                          Live Link
                        </Link>
                      </li>
                      <li>
