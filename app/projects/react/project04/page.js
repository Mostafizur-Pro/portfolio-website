          ...
          <div className="text-white ml-6 mt-8 text-base ">
            ...
            <div className="my-4">
              ...
              <div className="font-semibold sm:text-base text-sm">
                International IT Association of Bangladesh (IITAB) is a leading
                software company dedicated to providing innovative IT solutions
                and services to clients worldwide. With a focus on excellence,
                integrity, and customer satisfaction, IITAB leverages
                cutting-edge technologies and best practices to deliver
                high-quality software products and digital solutions tailored to
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/react/project04/image01.png"
                width={700}
                height={700}
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/react/project04/image02.png"
                width={700}
                height={700}
                className="border-4 border-sky-300 rounded-lg"
                alt="spin"
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/react/project04/image03.png"
                width={700}
                height={700}
                className="border-4 border-sky-300 rounded-lg"
                alt="spin"
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/react/project04/image04.png"
                width={700}
                height={700}
                className="border-4 border-sky-300 rounded-lg"
                alt="spin"
                ...
                <tr>
                  ...
                  <td className="font-semibold text-red-600  sm:text-base text-sm pl-6  break-all">
                    <ul className="list-disc">
                      <li>
                        {" "}
                        <Link target="_blank" href={"https://iitab.us/"}>
                          Live Link
                        </Link>
                      </li>
                      <li>
