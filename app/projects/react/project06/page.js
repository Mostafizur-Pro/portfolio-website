        ...
        <div className="sm:px-8 px-4 grow">
          ...
          <div className="text-white ml-6 mt-8 text-base ">
            <div className="flex gap-2">
              ...
              <div className="font-semibold">Computer Zone </div>
            </div>
            <div className="flex gap-2">
            ...
            <div className="my-4">
              ...
              <div className="font-semibold sm:text-base text-sm">
                <strong>Computer Zone</strong> is an innovative e-commerce platform dedicated
                to facilitating the seamless buying and selling of computer
                parts and products. Our platform is designed to cater to the
                needs of tech enthusiasts, professionals, and businesses alike,
                offering a wide range of high-quality computer components,
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/react/project06/image01.png"
                width={700}
                height={700}
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/react/project06/image02.png"
                width={700}
                height={700}
                className="border-4 border-sky-300 rounded-lg"
                alt="spin"
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/react/project06/image03.png"
                width={700}
                height={700}
                className="border-4 border-sky-300 rounded-lg"
                alt="spin"
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/react/project06/image04.png"
                width={700}
                height={700}
                className="border-4 border-sky-300 rounded-lg"
                alt="spin"
                ...
                <tr>
                  ...
                  <td className="font-semibold text-red-600  sm:text-base text-sm pl-6  break-all">
                    <ul className="list-disc">
                      <li>
                        {" "}
                        <Link target="_blank" href={"https://computer-zone-a3f6f.web.app/"}>
                          Live Link
                        </Link>
                      </li>
                      <li>
                        ...
                        <Link
                          href={
                            "https://github.com/Mostafizur-Pro/Computer-Zone"
                          }
                        >
                          Client Side
                        </Link>
