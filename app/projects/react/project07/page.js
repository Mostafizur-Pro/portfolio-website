        ...
        <div className="sm:px-8 px-4 grow">
          ...
          <div className="text-white ml-6 mt-8 text-base ">
            <div className="flex gap-2">
              ...
              <div className="font-semibold">E-Shoppers </div>
            </div>
            <div className="flex gap-2">
            ...
            <div className="my-4">
              ...
              <div className="font-semibold sm:text-base text-sm">
                <strong>e-Shoppers</strong> is a dedicated e-commerce platform
                catering to the needs and preferences of women, offering a
                diverse range of products tailored to enhance their lifestyle,
                fashion, and well-being. Our platform is designed to provide a
                seamless and enjoyable shopping experience, empowering women to
                discover and acquire the products that complement their unique
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/react/project07/image01.png"
                width={700}
                height={700}
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/react/project07/image02.png"
                width={700}
                height={700}
                className="border-4 border-sky-300 rounded-lg"
                alt="spin"
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/react/project07/image03.png"
                width={700}
                height={700}
                className="border-4 border-sky-300 rounded-lg"
                alt="spin"
            ...
            <div className="sm:ml-6 mt-4">
              <Image
                src="/images/react/project07/image04.png"
                width={700}
                height={700}
                className="border-4 border-sky-300 rounded-lg"
                alt="spin"
                  ...
                  <td className="font-semibold text-red-600  sm:text-base text-sm pl-6  break-all">
                    <ul className="list-disc">
                      <li>
                        ...
                        <Link
                          target="_blank"
                          href={"https://eshoppers-bd.netlify.app/"}
                        >
                          Live Link
                        </Link>
                      </li>
                      <li>
                        ...
                        <Link
                          href={
                            "https://github.com/Mostafizur-Pro/eShopers-bd-client"
                          }
                        >
                          Client Side
                        </Link>
