        ...
        <div className="px-8 grow">
          ...
          <div className="text-white ml-6 mt-8 text-base font-semibold">
            <p className="text-center sm:text-start">
              ...
              development, I enjoy complex problem solving with logical thinking
              and have a good practice of UI UX designing. Committed to
              continuous learning, I am eager to contribute to dynamic software
              development projects and make a meaningful impact in industry.
            </p>
          </div>
        </div>
